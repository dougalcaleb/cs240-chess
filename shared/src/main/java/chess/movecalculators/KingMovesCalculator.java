...
public class KingMovesCalculator extends PieceMovesCalculator
{
    ...
    public KingMovesCalculator(ChessBoard board, ChessPosition position, TeamColor teamColor, boolean hasMoved) {
    ...
    public List<ChessMove> getMoves() {
        ...
        if (
            ...
            KingInCheckCalculator.getSafeMoves(currentBoard, traversedKingSide, teamColor).size() == 3 // all spaces are safe
        )
        {
        ...
        if (
            ...
            KingInCheckCalculator.getSafeMoves(currentBoard, traversedQueenSide, teamColor).size() == 3 // all spaces are safe
        )
        {
